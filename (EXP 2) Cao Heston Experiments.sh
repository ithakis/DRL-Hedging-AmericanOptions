#!/bin/bash
#  nohup "./(EXP 2) Cao Heston Experiments.sh" > .terminal_output2.txt 2>&1 &
...
# # python runAlexander.py "${args_Mean_Std[@]}" -logger_prefix='(EXP 2) Heston Experiments/spread_2/Heston_Mean_Std_Batch/Heston_Mean_Std_2_1' -train_seed=1234 &
